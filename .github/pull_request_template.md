...
## Trust / data / claim-safety impact
...
Run `bash scripts/ai/usage_snapshot.sh` and paste the output line below.
If ccusage is unavailable, use statusline token count or estimate manually.
