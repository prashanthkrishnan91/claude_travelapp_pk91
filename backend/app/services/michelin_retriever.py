...
_MICHELIN_DB: dict[str, list[dict]] = {
    ...
    "honolulu": [
        {"name": "Vintage Cave", "michelin_status": "2 Stars", "cuisine": "Contemporary French-Japanese", "neighborhood": "Ala Moana", "rating": 9.3, "review_count": 560, "summary": "Ultra-exclusive 12-seat underground restaurant. One of Hawaii's most prestigious tasting menu experiences.", "tags": ["Fine Dining", "Tasting Menu", "Exclusive", "Intimate"]},
        {"name": "Senia", "michelin_status": "1 Star", "cuisine": "Modern Hawaiian", "neighborhood": "Chinatown", "rating": 9.0, "review_count": 1400, "summary": "Chris Kajioka's farm-to-table Hawaiian tasting menu using hyper-local ingredients from O'ahu farms.", "tags": ["Tasting Menu", "Local", "Innovative", "Seasonal"]},
        {"name": "MW Restaurant", "michelin_status": "1 Star", "cuisine": "Hawaii Regional", "neighborhood": "Ala Moana", "rating": 8.8, "review_count": 2100, "summary": "Wade Ueoka and Michelle Karr-Ueoka's love letter to Hawaiian regional cuisine. Outstanding poke and local fish.", "tags": ["Hawaii Regional", "Romantic", "Local"]},
        {"name": "Nobu Honolulu", "michelin_status": "Selected", "cuisine": "Japanese-Peruvian", "neighborhood": "Waikiki", "rating": 8.7, "review_count": 4100, "summary": "Nobu Matsuhisa's iconic fusion steps from the beach. Black cod miso and sushi in a stunning oceanside setting.", "tags": ["Sushi", "Waikiki", "Romantic", "Near Beach"]},
        {"name": "Grondin", "michelin_status": "Bib Gourmand", "cuisine": "French-Latin", "neighborhood": "Chinatown", "rating": 8.5, "review_count": 1800, "summary": "French bistro meets Latin flavors in Honolulu's vibrant Chinatown arts district. Outstanding value wine list.", "tags": ["Value", "Chinatown", "Romantic", "Wine"]},
        {"name": "Moku Kitchen", "michelin_status": "Bib Gourmand", "cuisine": "Modern Hawaiian", "neighborhood": "Kaka'ako", "rating": 8.4, "review_count": 3200, "summary": "Craft beer and wood-fired plates in a lively Kaka'ako setting. Best value Hawaiian plates on the island.", "tags": ["Value", "Casual", "Local", "Wood Fire"]},
    ],
    "hawaii": [
        {"name": "Vintage Cave", "michelin_status": "2 Stars", "cuisine": "Contemporary French-Japanese", "neighborhood": "Ala Moana", "rating": 9.3, "review_count": 560, "summary": "Ultra-exclusive 12-seat underground restaurant. One of Hawaii's most prestigious tasting menu experiences.", "tags": ["Fine Dining", "Tasting Menu", "Exclusive", "Intimate"]},
        {"name": "Senia", "michelin_status": "1 Star", "cuisine": "Modern Hawaiian", "neighborhood": "Chinatown", "rating": 9.0, "review_count": 1400, "summary": "Chris Kajioka's farm-to-table Hawaiian tasting menu using hyper-local ingredients from O'ahu farms.", "tags": ["Tasting Menu", "Local", "Innovative", "Seasonal"]},
