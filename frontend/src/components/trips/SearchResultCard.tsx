    ...
    >
      <Card.Identity>
        ...
        <button
          {...listeners}
          {...attributes}
          className="mt-0.5 flex-shrink-0 cursor-grab active:cursor-grabbing text-ds-text-tertiary hover:text-ds-text-secondary transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-ds-accent focus-visible:outline-offset-2"
            ...
            <div className="flex items-center gap-1 flex-shrink-0">
              {onToggleCompare && (
                <button
                  ...
                  className={`w-6 h-6 rounded-full flex items-center justify-center transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-ds-accent focus-visible:outline-offset-2 ${
                    isComparing
                      ? "bg-ds-accent text-ds-text-inverse"
                      : "bg-ds-carbon text-ds-text-tertiary hover:text-ds-accent"
                  }`}
              ...
              {result.bookingUrl && (
                <a
                  ...
                  className="w-6 h-6 rounded-full bg-ds-carbon hover:bg-ds-pen-stroke text-ds-text-tertiary hover:text-ds-text-secondary flex items-center justify-center transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-ds-accent focus-visible:outline-offset-2"
              ...
              <button
                ...
                className="w-6 h-6 rounded-full bg-ds-accent hover:bg-ds-accent-muted text-ds-text-inverse flex items-center justify-center transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-ds-accent focus-visible:outline-offset-2"
